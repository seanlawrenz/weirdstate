export type HubMethod = (callback: (data: string) => void) => any;
...
export interface HubProxy {
  ...
  invoke(methodName: string, ...args: any[]): any; // JQueryDeferred<any>;
}
...
export interface HubConnection extends SignalR {
